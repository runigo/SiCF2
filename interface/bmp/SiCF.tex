...
%        ECRAN
%
    \fill[white,draw=black,thick](-21,-0.7) rectangle (28,31.2);
%
	% CAPTEURS HAUT
    \def\hauteur{7.7}
%   SPECTRE GAUCHE
  \begin{scope}[xshift=-16.7 cm,yshift=\hauteur cm]
    % Draw axes
    \draw [<->,draw=gray,thick] (0,7) node (yaxis) [above] {$\acute{e}nergie\ gauche$}
        |- (16,0) node (xaxis) [right] {$f$};
  \end{scope}
%   SPECTRE DROITE
  \begin{scope}[xshift=1.3 cm,yshift=\hauteur cm]
    % Draw axes
    \draw [<->,draw=gray,thick] (0,7) node (yaxis) [above] {$\acute{e}nergie\ droite$}
        |- (16,0) node (xaxis) [right] {$f$};
  \end{scope}
%
%      PANNEAU  BAS
...
%      PANNEAU  COUPLAGE
%
  \fill[panneaucontroles] (20.1,21.5) rectangle (27.6,30.7);
  \begin{scope}[xshift=22.7 cm,yshift=27.2cm]
  ...
  \begin{scope}[xshift=22.7 cm,yshift=27.6cm,scale=0.85]
  ...
  \begin{scope}[xshift=22.7 cm,yshift=23.3cm,scale=0.70]
    \node[scale=\scl] at (0,2.6) {\LARGE \textbf{Masse droite}};
    \clip[rounded corners] (-2,-2) rectangle (2,2);
    \fill[black!30!,rounded corners,draw=black,thick] (-2,-2) rectangle (2,2);
    \draw[very thick,rounded corners](-2,-2) rectangle (2,2);
    \draw[thick] (0,0) circle (1.0);
